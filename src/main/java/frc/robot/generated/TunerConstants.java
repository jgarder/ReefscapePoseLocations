...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(110.0).withKI(0).withKD(0.0) //P150 with fresh tires? 
    ...
    //Insane results, we just set the bumpers on top of the robot and all 4 wheels were stalling at 130 amps stator!!
    ...
    private static final Distance kWheelRadius = Inches.of(1.962);
    ...
    //using a 2 digit CANid Naming system, first digit is Drive(1):steer(2):cancoder(3), 
    //second digit is which corner it's in FrontLeft(1):FrontRight(2):BackLeft(3):Backright(4)
    //for example 24 is the backright steer
    //(Only for drivetrain, though we could add 4 to digit one for "other")
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.1337890625);
    private static final boolean kFrontLeftSteerMotorInverted = true;
    private static final boolean kFrontLeftEncoderInverted = false;

    private static final Distance kFrontLeftXPos = Inches.of(13.37);
    ...
    private static final Distance kFrontRightXPos = Inches.of(13.37);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-13.37);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.085693359375);
    private static final boolean kBackRightSteerMotorInverted = true;
    private static final boolean kBackRightEncoderInverted = false;

    private static final Distance kBackRightXPos = Inches.of(-13.37);
